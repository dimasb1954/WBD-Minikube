...
CREATE TABLE "connection_request" (
    ...
    CONSTRAINT connection_request_from_to_unique UNIQUE (from_id, to_id),
    CONSTRAINT connection_request_from_to_check CHECK (from_id != to_id)
);
...
CREATE TABLE "connection" (
    ...
    CONSTRAINT connection_from_to_unique UNIQUE (from_id, to_id),
    CONSTRAINT connection_from_to_check CHECK (from_id != to_id)
);
